...
ggplot(power_df, aes(x = n, y = Power, color = Test)) +
  ...
  geom_vline(xintercept = final_sample_size_st2, colour = "#E31A1C", linetype = "dotted") + # Línea vertical: equivalencia
  annotate("text",
  ...
  geom_vline(xintercept = p_sample_size_st2, colour = "#2c3e50", linetype = "dotted") + # Línea vertical: detección
  annotate("text",
...
# Graficamos ambos paneles
ggarrange(
  # Panel A: Resultados del test de equivalencia bajo rho = 0
  ggplot(df_sim_0, aes(x = r_obs, fill = equiv)) +
    ...
    theme_tq(),
  # Panel B: Resultados simulados bajo rho = 0.3
