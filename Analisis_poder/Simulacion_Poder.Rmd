...
El código completo está disponible en el Open Science Framework (OSF): \colorbox{pink}{https://doi.org/10.XXXXXX}. La estrategia de análisis de poder y los análisis/modelos principales fueron diseñados por Juan David Leongómez. Este documento y todo su código subyacente fueron elaborados en R Markdown por Juan David Leongómez utilizando R y \LaTeX.
